...
################################################################
## FPWLS procedure for estimating beta with specified truncation parameters ##
...
### FPWLS-based AIC criterion for selecting s_nj ###
...
## FPWLS-based estimation and variable selection with 
